...
class SymbolRow(Base):
    ...
    __table_args__ = (
        UniqueConstraint("venue", "exchange_symbol", name="uq_symbols_venue_exchange"),
        {"schema": "market"},
    )
...
class CandleRow(Base):
    ...
    __table_args__ = (
        CheckConstraint("high >= low", name="ck_candles_hl"),
        CheckConstraint(
...
class IncidentRow(Base):
    ...
    candle_span: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
